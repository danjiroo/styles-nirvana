...
const SingleSelect = (_a) => {
    var { error, errorText, icon, name, isCreatable = false, isDisabled = false, isRequired = false, isLoading = false, label, selectOptions: options, handleChange, placeholder, valueData = '', isMulti = false, rounded = false, color = 'primary', colorWeight = '200', size = 'xl', className } = _a, restProps = __rest(_a, ["error", "errorText", "icon", "name", "isCreatable", "isDisabled", "isRequired", "isLoading", "label", "selectOptions", "handleChange", "placeholder", "valueData", "isMulti", "rounded", "color", "colorWeight", "size", "className"]);
    const styleProps = {
        error,
        label,
        icon,
