...
const Table = (props) => {
    ...
    const { getTableProps, getTableBodyProps, headerGroups, rows, prepareRow, setHiddenColumns, getToggleAllRowsSelectedProps, selectedFlatRows, } = (0, react_table_1.useTable)({
        // @ts-ignore
