...
const Table = (props) => {
    var _a;
    const { columns = [], data = [], actions, options, isLoading = false, customComponent, } = props;
    const { config } = options !== null && options !== void 0 ? options : {};
    const { enablePagination = true, initialState, showCurrentPage = true, } = config !== null && config !== void 0 ? config : {};
    const _b = initialState !== null && initialState !== void 0 ? initialState : {}, { paginationRange, sortOrder = 'descending', sortBy } = _b, restInitialState = __rest(_b, ["paginationRange", "sortOrder", "sortBy"]);
