...
const Table = (props) => {
    ...
    if (customComponent) {
        return ((0, jsx_runtime_1.jsxs)(styles_1.StyledTableAndPaginationContainer, { children: [(0, jsx_runtime_1.jsx)(CustomComponent_1.default, { items: data, customComponent: customComponent }), enablePagination && (0, jsx_runtime_1.jsx)(DefaultPagination_1.default, Object.assign({}, paginationProps))] }));
    }
